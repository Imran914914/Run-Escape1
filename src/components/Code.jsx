    ...
    <div className='bg md:w-full h-full flex justify-center'>
      <div className='h-full bg-[#0f1722] w-max rounded-md p-10'>
        ...
        <div className='flex justify-center mt-5 w-full flex-col '>
            <p className='text-white text-3xl flex justify-center w-full'>We've emailed you a</p>
            <p className='text-white text-3xl flex justify-center w-full'>verification code</p>
        </div>
        <div>
        <div className='flex justify-center mt-5'><p className='text-white'>Please enter the code sent to <b>{emailValaue}</b> to continue</p></div>
        </div>
        ...
        <div className="relative mt-5 w-full">
            ...
            <label htmlFor="floating_outlined" className="absolute text-sm text-[#9b9ba2] dark:text-gray-400 duration-200 transform -translate-y-4 scale-75 top-5 z-10 origin-[0] bg-white dark:bg-gray-900 px-2 peer-focus:px-2 peer-focus:text-blue-600 peer-focus:dark:text-[#9b9ba2] peer-placeholder-shown:scale-100 peer-placeholder-shown:-translate-y-1/2 peer-placeholder-shown:top-1/2 peer-focus:top-2 peer-focus:scale-75 peer-focus:-translate-y-2 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto start-1">Verification code</label>
        </div>
        <button className='bg-[#0c8ae6] w-full h-12 rounded-md text-sm mt-5'>Continue</button>
        <a href="/" className='flex justify-center mt-8 text-blue-400 text-sm hover:underline'>Verify another way</a>
      </div>
    </div>
  )
}
